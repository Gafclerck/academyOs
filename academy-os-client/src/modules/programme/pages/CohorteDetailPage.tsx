...
export const CohorteDetailPage: React.FC = () => {
  ...
  const [
    activeTab,
    setActiveTab,
  ] = useState<'membres' | 'projets'>('membres')
  ...
  const {
    data: kpis,
  } = useCohorteDetailKPIs(id)

  const {
    data: membres = [],
    isLoading: membLoading,
  } = useMembresByCohorte(id)

  const {
    data: projets = [],
    isLoading: projLoading,
  } = useProjetsByCohorte(id)

  /* ================= MEMBRES ================= */

  const membresColumns = useMemo<
    ColumnDef<Membre>[]
  >(
    () => [
      {
  ...
  const projetsColumns = useMemo<
    ColumnDef<ProjetCohorte>[]
  >(
    () => [
      {
        accessorKey: 'nom',
