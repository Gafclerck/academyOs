    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2 border-b border-slate-200 dark:border-white/10 pb-1">
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 text-sm font-bold rounded-xl transition-colors ${activeTab === 'membres'
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 text-sm font-bold rounded-xl transition-colors ${activeTab === 'projets'
            ? 'bg-[#FF6B0B]/10 text-[#FF6B0B]'
            : 'text-slate-500 hover:text-slate-900 dark:hover:text-white'
            }`}
        >
