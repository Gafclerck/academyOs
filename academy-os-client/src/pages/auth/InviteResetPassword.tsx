          ...
          >
            ...
            {success ? (
              ...
              >
                ...
                >
                  Votre mot de passe et vos informations
                  personnelles ont été enregistrés avec succès.
                  <br />
              ...
              <>
                ...
                >
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-500 dark:text-slate-400">
                    Complétez vos informations pour finaliser
                    votre inscription à Xarala.
                  </p>
                ...
                >
                  ...
                  <motion.div variants={itemVariants}>
                    ...
                    <div className="group relative">
                      ...
                      <User className="absolute left-4 top-1/2 z-10 size-4 -translate-y-1/2 text-slate-400 transition-colors group-focus-within:text-[#FF6B0B] dark:text-slate-500" />
                  ...
                  <motion.div variants={itemVariants}>
                    ...
                    <div className="group relative">
                      ...
                      <Phone className="absolute left-4 top-1/2 z-10 size-4 -translate-y-1/2 text-slate-400 transition-colors group-focus-within:text-[#FF6B0B] dark:text-slate-500" />
