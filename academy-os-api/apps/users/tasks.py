...
def send_email_async(self, subject, message, recipient_list, from_email=None):
    """Tâche Celery asynchrone pour l'envoi d'emails avec retry automatique en cas d'erreur SMTP."""
    ...
    try:
        ...
        return send_mail(subject, message, sender, recipient_list, fail_silently=False)
